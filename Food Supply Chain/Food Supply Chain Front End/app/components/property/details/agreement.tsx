...
import { onAgreementAmount } from "@/core/api/transactions";
...
const Agreement: React.FC<any> = ({ propertyDetails, propertyTrasnsaction, processTrigger }: Prop) => {
    ...
    useEffect(() => {
        let remAmount = propertyTrasnsaction.finalAmount - propertyTrasnsaction.tokenAmount;
        setAgreementAmount(remAmount.toString());
    }, []);
    ...
    return (
        <div>
            ...
            <p className="mb-8"><strong>Final Amount:</strong> {propertyTrasnsaction.finalAmount}</p>
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    ...
                    <input
                        ...
                        onChange={(e) => {console.log(e.target.value); setAgreementAmount(e.target.value)}}
                        required
                    />
                </div>
