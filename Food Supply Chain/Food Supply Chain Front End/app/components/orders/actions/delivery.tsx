...
import { retailerAcceptance } from "@/core/api/orders";

const Delivery: React.FC<any> = ({ orderDetails, productDetails, orderProcessedDetails, processTrigger }) => {
    ...
    const onReject = () => {
        ...
        retailerAcceptance(payload)
            .then(response => {
                console.log('rejectDelivery Response:', response);
